...
const WhyChooseSection: FC<Props> = ({ title = "WHY CHOOSE REDUCTIONLY" }) => {
  return (
    <section className="bg-[#F2F8ED] py-12 md:py-28 lg:py-32 text-center rounded-t-[40px] -mt-5 md:-mt-14 xl:-mt-20 relative z-30 px-8 md:mx-3">
      <h2 className="text-[36px] md:text-[44px] font-semibold leading-[115%] text-[#062014] mb-8 RightGrotesk">
        {title}
      </h2>
      ...
      <div className="flex flex-wrap justify-center gap-3 md:gap-4 max-w-5xl mx-auto">
        {features.map((feature, index) => (
          <div key={index} className="basis-full md:basis-auto">
            <div className="inline-flex items-center gap-2 bg-[#004725] text-white px-4 md:px-5 py-3 md:py-3 rounded-full text-base md:text-lg font-semibold mx-auto transition-all hover:scale-[1.02] hover:bg-[#0A5A36] RightGrotesk">
      ...
      <p className="mt-8 text-[#062014] text-[19px] md:text-lg font-semibold mx-auto leading-[153%] RightGrotesk max-w-[896px]">
