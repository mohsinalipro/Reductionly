  ...
  return (
    <section className="bg-[#F8FDE9] rounded-[50px] pt-20 pb-28">
      <div className="max-w-screen-xl mx-auto px-5 text-center">
        <h2 className="text-2xl md:text-3xl lg:text-[44px] text-[#062014] font-bold mb-12 md:mt-14">WE SPECIALIZE IN:</h2>
          ...
          {specializations.map((item, index) => (
            ...
            >
              <div className="flex-1 md:text-left max-w-[400px] text-center">
                <h3 className="text-[28px] md:text-[32px] md:leading-10 font-bold mb-5 md:mb-6 text-[#062014]">{item.title}</h3>
