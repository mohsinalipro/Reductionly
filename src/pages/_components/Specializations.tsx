  ...
  return (
    <section className="bg-[#F8FDE9] rounded-[50px] pt-20 pb-28">
      <div className="max-w-screen-xl mx-auto px-5 text-center">
        <h2 className="text-[32px] leading-[115%] md:text-[44px] text-[#062014] font-semibold mb-2 md:mb-8 lg:mb-12 md:mt-14 RightGrotesk">WE SPECIALIZE IN:</h2>
          ...
          {specializations.map((item, index) => (
            ...
            >
              <div className="flex-1 md:text-left max-w-[400px] text-center">
                <h3 className="text-[28px] leading-[32px] md:text-[32px] md:leading-10 font-bold mb-5 md:mb-6 text-[#062014] RightGrotesk">{item.title}</h3>
                <p className="text-[#062014] mb-5 md:mb-7 text-[19px] md:text-lg leading-7">{item.description}</p>
                <GlobalBtn
