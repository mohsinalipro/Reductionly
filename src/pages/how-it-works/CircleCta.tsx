...
export default function CircleCta() {
  return (
    <section className="bg-[#004725] text-white pb-16 md:pb-24">
      <div className="max-w-screen-xl mx-auto px-5">
        <div className="relative mx-auto w-full max-w-[720px] aspect-square flex items-center justify-center">
          ...
          <div className="relative z-10 text-center max-w-[360px]">
            <h3 className="text-xl md:text-2xl font-extrabold mb-3">READY TO MAKE YOUR STUDENT LOANS MANAGEABLE?</h3>
            <p className="text-[19px] md:text-lg leading-7 opacity-90 mb-5">Take the first step today — it’s faster and easier than you think.</p>
            <GlobalBtn
